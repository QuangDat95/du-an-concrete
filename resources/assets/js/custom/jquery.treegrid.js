...
(function($) {
    ...
    var methods = {
        ...
        initSettingsEvents: function() {
            ...
            $this.on("collapse", function() {
                var $this = $(this);
                if (
                    typeof $this.treegrid('getSetting', 'onCollapse') === "function") {
        ...
        initIndent: function() {
            ...
            for (var i = 0; i < depth; i++) {
                if((depth - i) >= 2) {
                    var tpl = $this.treegrid('getSetting', 'indentTemplateUnset');
    ...
    $.fn.treegrid.defaults = {
        ...
        indentTemplateUnset: '<span class="treegrid-indent"></span>',
