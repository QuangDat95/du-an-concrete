...
<div class="card" id="card-form-survey">
    ...
    <div class="card-content">
        <div class="card-body">
            <form id="form-add-survey-record" action="{{route('surveyDetails.addSurvey',['survey'=>$survey->id])}}"
                ...
                <div class="form-body">
                    ...
                    <span style="display:none" id="list-constructions">{{getConstructions()}}</span>
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-color-dufago mr-1 mb-1 placement"
                            id="btn-submit-survey-responses">Gửi</button>
