...
<body onload="window.print()">
    <div class="main-page">
        <div class="sub-page">
            ...
            <div style="position:absolute">
                <h2 style="position:relative;right:-289px;top:86px">BÁO CÓ</h2>
            </div>
            <div style="position:absolute">
                <span style="position: relative;top:120px;right:-262px">
                    <?php
				$paymentdate = explode('-',$alert->payment_date);
				?>
                ...
                <table class="table" style="width:260px;font-size:14px;position:relative;right:-465px;top:98px">
                    <thead>
                        <tr>
                            ...
                            <th><span style="float:left">{{$alert->code}}</span></th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <table class="table" style="font-size:14px;width:131mm;position:relative;top:245px">
                    <thead>
                        <tr>
                            ...
                            <th colspan="4">
                                <div style="float:left">{{str_replace(',','.',number_format($alert->amount))}} đồng
                                </div>
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style="width:72px">Bằng chữ:</td>
                            <th colspan="4"><div style="float:left">{{ucfirst(convert_number_to_words($alert->amount))}} đồng</div></th>
                        </tr>
                        <tr>
