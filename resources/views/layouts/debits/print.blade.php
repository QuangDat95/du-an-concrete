...
<body onload="window.print()">
    <div class="main-page">
        <div class="sub-page">
            ...
            <div style="position:absolute">
                <h2 style="position:relative;right:-308px;top:86px">BÁO NỢ</h2>
            </div>
            <div style="position:absolute">
                <span style="position: relative;top:120px;right:-262px">
				<?php
				$paymentdate = explode('-',$debit->payment_date);
				?>
                ...
                <table class="table" style="width:260px;font-size:14px;position:relative;right:-465px;top:98px">
                    <thead>
                        <tr>
                            ...
                            <th><span style="float:left">{{$debit->code}}</span></th>
                        </tr>
                    </thead>
                    <tbody>
                ...
                <table class="table" style="font-size:15px;width:143mm;position:relative;top:170px">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th colspan="5">
                                <div style="float:left">{{$debit->payment_user}}</div>
                            </th>
                        </tr>
                        <tr>
                            <td>Đại diện đơn vị<div style="float:right">:</div>
                            </td>
                            <td colspan="5">{{$debit->partyable_name}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="5">
                                <div style="float:left"><b>{{str_replace(',','.',number_format($debit->amount))}}
                                        đồng</b>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="6">Bằng chữ : <span
                                    style="font-weight:bold">{{ucfirst(convert_number_to_words($debit->amount))}}
                                    đồng</span></td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div style="position:absolute">
                <span style="font-size:14px;position:relative;top:333px">Kèm theo:_______________________________________
                    chứng từ gốc</span>
            </div>
