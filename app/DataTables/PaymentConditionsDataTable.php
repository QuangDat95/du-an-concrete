...
class PaymentConditionsDataTable extends DataTable
{
    ...
    public function query(PaymentCondition $model)
    {
    ...
    public function html()
    {
        ...
        return $this->builder()
            ->columns([
                ...
                'name'  => ['title'=> 'Điều kiện thanh toán'],
                'date_owned'  => ['title'=> 'Ngày được nợ']
            ])->parameters($params);
    }
}
